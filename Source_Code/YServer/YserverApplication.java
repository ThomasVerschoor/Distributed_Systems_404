...
public class YserverApplication {
    ...
    public static void main(String[] args){
        System.out.println("----------------------------------------------------");
        NodeHandler.addNode("Mathijs","/192.168.1.9");
        NodeHandler.addNode("Bilal","/192.168.1.9");
        NodeHandler.addNode("Jorre","/192.168.1.9");
        NodeHandler.addNode("Thomas","/192.168.1.9");
