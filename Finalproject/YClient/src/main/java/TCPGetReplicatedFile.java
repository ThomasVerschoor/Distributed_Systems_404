...
public class TCPGetReplicatedFile extends Thread{
    ...
    public void run(){
        ...
        if (running) {
            ...
            try {
                ...
                //TODO: UNCOMMENT WHEN TESTING ON LOCAL MACHINE!!!!
                //String[] filesplit = fileName.split("\\.", 2);
                //fileName = filesplit[0] + "shut." + filesplit[1];
                ...
                //TODO: UNCOMMENT WHEN TESTING ON LOCAL MACHINE!!!!
                //filesplit = logFileName.split("\\.", 2);
                //logFileName = filesplit[0] + "shut." + filesplit[1];
            ...
            try {
                ...
                fileOutputStream = new FileOutputStream(filePath+"/"+fileName);  //linux
            ...
            try {
                ...
                //TODO: Linux - Windows change
                logFileOutputStream = new FileOutputStream(filePath+"/"+logFileName);  //linux
               ...
               //UPDATE LOGFILE
               updateLog(hostName, logFileName);
    ...
    public void updateLog(String hostname, String logFileName) throws IOException {
        //Update log
        //TODO: Linux - Windows change
        outdatedLog = new File(filePath + "/" + logFileName); //linux
        //outdatedLog = new File(filePath + "\\" + logFileName); //windows
        String oldContent = "";
        BufferedReader reader = new BufferedReader(new FileReader(outdatedLog));
        ...
        String newContent = oldContent.replaceAll(hostname, YClient.hostName);

        FileWriter writer = new FileWriter(outdatedLog);
