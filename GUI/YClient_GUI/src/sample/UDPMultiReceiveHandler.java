...
public class UDPMultiReceiveHandler extends Thread {
    ...
    public UDPMultiReceiveHandler(String hostName, InetAddress multicastAddress, int multiCastPort) {
        ...
        System.out.println("Starting UDPMultiRecieve handler listening on port: "+multiCastPort);
        System.out.println("Adding multicast port to group with IP: "+multicastAddress);
        try {
