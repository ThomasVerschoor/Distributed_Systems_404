...
public class MultiThreadServer {
    ...
    static class MultiThreadClientHandler extends Thread{
        final DataInputStream dataIn;
        final DataOutputStream dataOut;
        final Socket socket;

        MultiThreadClientHandler(Socket socket, DataInputStream dataIn, DataOutputStream dataOut) {    //Elke keer als er een nieuwe client wil verbinden
