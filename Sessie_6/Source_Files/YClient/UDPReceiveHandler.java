...
public class UDPReceiveHandler extends Thread {
    ...
    public UDPReceiveHandler(int recievePort) {
        ...
        System.out.println("Starting UDPRecieve handler listening on port: "+recievePort);
        try {
            UDPReceiveHandler.recieveSocket = new DatagramSocket(UDPReceiveHandler.recievePort);
