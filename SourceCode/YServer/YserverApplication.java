...
public class YserverApplication {
    ...
    private static final int sendPort = 4499;
    ...
    public static void main(String[] args){
        System.out.println("----------------------------------------------------");
        /*NodeHandler.addNode("Mathijs","/192.168.151.18");
        NodeHandler.addNode("Bilal","/192.168.151.18");
        NodeHandler.addNode("Jorre","/192.168.151.18");
        NodeHandler.addNode("Thomas","/192.168.151.18");*/
